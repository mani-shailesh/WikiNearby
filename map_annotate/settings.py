"""
Django settings for C{map_annotate} project.
...
SECRET_KEY = 'k-#=#@cnl+duf@&^(ycap5fjx8-ozpqci6cap^)el8aqga@9ov'
...
ROOT_URLCONF = 'map_annotate.urls'
...
WSGI_APPLICATION = 'map_annotate.wsgi.application'
